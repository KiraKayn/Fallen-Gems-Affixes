...
@EventBusSubscriber(modid = FallenGemsAffixes.MOD_ID, value = Dist.CLIENT)
public class ProspectorHighlightHandler {
    ...
    private static void renderBox(BufferBuilder buf, Matrix4f mat,
        ...
        // Bottom face
        buf.addVertex(mat, (float)x1, (float)y1, (float)z1).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x2, (float)y1, (float)z1).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x2, (float)y1, (float)z1).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x2, (float)y1, (float)z2).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x2, (float)y1, (float)z2).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x1, (float)y1, (float)z2).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x1, (float)y1, (float)z2).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x1, (float)y1, (float)z1).setColor(r,g,b,a);
        // Top face
        buf.addVertex(mat, (float)x1, (float)y2, (float)z1).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x2, (float)y2, (float)z1).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x2, (float)y2, (float)z1).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x2, (float)y2, (float)z2).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x2, (float)y2, (float)z2).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x1, (float)y2, (float)z2).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x1, (float)y2, (float)z2).setColor(r,g,b,a);
        buf.addVertex(mat, (float)x1, (float)y2, (float)z1).setColor(r,g,b,a);
        // Vertical edges
        buf.addVertex(mat, (float)x1, (float)y1, (float)z1).setColor(r,g,b,a);
